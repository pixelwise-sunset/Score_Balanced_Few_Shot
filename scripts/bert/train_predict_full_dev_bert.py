#!/usr/bin/env python
"""Train metric-specific PubMedBERT models on full dev and predict English test."""
...
def short_caption(row) -> str:
    caption = clean(row.get("image_caption", ""))
    return caption[:300]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_name", default="/data/public_models/bert/pubmedbert")
